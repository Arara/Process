...
The `Arara\Process\IPC\SharedMemory` used `Semaphore` for internal locks so can be safely used for inter process communications.
...
SharedMemory, Semaphore, and the above example written by Nikolay Bondarenko (misterionkell at gmail.com) as a part of [GameNet project](http://gamenet.ru) by Nikolay Bondarenko (misterionkell at gmail.com).

These classes have been included in this distribution under the terms of the [MIT](LICENSE) license.
