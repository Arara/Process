...
$action->bind(Action::EVENT_START, function (Control $control, array $context) {
    echo 'Start: ' . json_encode($context, (defined('JSON_PRETTY_PRINT') ? JSON_PRETTY_PRINT : 0)) . PHP_EOL;
});
