...
$action->bind(Action::EVENT_FINISH, function (Control $control, Context $context) {
    echo 'Finish: ' . json_encode($context->toArray(), (defined('JSON_PRETTY_PRINT') ? JSON_PRETTY_PRINT : 0)) . PHP_EOL;
});
